...
<nav class="navbar navbar-expand-sm navbar-light">
  ...
  <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link active" href="index.php"><h3 style="color:#574764">Pedro Jardinagens</h3></a>
        </li>
    </ul>
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php
      $user = "Pedro Jardinagems";
      echo "Nome: $user<br>Data de criação: 01/01/2022 - 10:24:18";
      ?>
      </div>
